...
// Calculate and display hitting rates
...
// Display fielding totals
dv.table(
  ["PO","A","E","TC","DP"],
  [[PO, A, E, TC, DP]]
);

// Calculate and display fielding percentage
...
// Display pitching totals
dv.table(
  ["IP","H","R","ER","BB","K","HR","BF","PC"],
  [[IP, H_p, R_p, ER, BB_p, K_p, HR_p, BF, PC]]
);

// Calculate and display pitching rates
